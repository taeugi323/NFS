...
ACLOCAL = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/missing autoconf
AUTOHEADER = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/missing autoheader
AUTOMAKE = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/missing makeinfo
...
STRIP = 
VERSION = 2016-03-25
abs_builddir = /usr/etc/ceph/NFS_success_nonsck
abs_srcdir = /usr/etc/ceph/NFS_success_nonsck
abs_top_builddir = /usr/etc/ceph/NFS_success_nonsck
abs_top_srcdir = /usr/etc/ceph/NFS_success_nonsck
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /usr/etc/ceph/NFS_success_nonsck/install-sh
